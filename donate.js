...
function showInfo() {
    ...
    var info = '<table class="table table-hover table-bordered"><tr><th>Application Number</th><td>'+applicationNo+'</td></tr><tr><th>Name</th><td>'+firstName+' '+lastName+'</td></tr><tr><th>Age</th><td>'+age+'</td></tr><tr><th>Blood Group</th><td>'+bloodGroup+'</td></tr><tr><th>Center</th><td>'+center+'</td></tr><tr><th>Time</th><td>'+time+'</td></tr></table>';
